...
%--------------------------------------------------------------------------
    ...
    methods
        function main(Algorithm,Problem)
            ...
            [~,FrontNo,CrowdDis,fSmax,fSmin] = MeOEnvironmentalSelection(Population,Problem.N,alt,eta,p,C,fSmax,fSmin,Problem.optimum,Norm);

            %% Optimization
            while Algorithm.NotTerminated(Population)
                MatingPool = TournamentSelection(2,Problem.N,FrontNo,-CrowdDis);
                Offspring  = OperatorGA(Population(MatingPool));
                [Population,FrontNo,CrowdDis,fSmax,fSmin] = MeOEnvironmentalSelection([Population,Offspring],Problem.N,alt,eta,p,C,fSmax,fSmin,Problem.optimum,Norm);
            end
        end
    end
end